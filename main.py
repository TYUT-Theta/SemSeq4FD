...
def parse_arguments():
    ...
    # Data Related
    parser.add_argument("--train", dest="train", type=str, default=r'./newrumcedtrain.csv')
    parser.add_argument("--dev", dest="dev", type=str, default=r'./newrumcedtest.csv')
    parser.add_argument("--test", dest="test", type=str, default='./test.xlsx', help='Out of domain test set')
    ...
    parser.add_argument("--config", dest="config", type=str, default='param.t7', help='Name for saving plots')
    parser.add_argument("--model_file", dest="model_file", type=str, default='param.t7', help='For '
